<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>登录密码:</label>
        <input type="password" placeholder="请输入你的登录密码" v-model="password" name="password" v-validate="{required:true,regex:/^[a-zA-Z0-9]{5,17}$/}" :class="{invalid:errors.has('password')}"/>
      ...
      <div class="btn">
        <button @click="sendMessage">完成注册</button>
      </div>
    </div>
